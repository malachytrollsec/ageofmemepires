...
requireText("project responsive stretch", project, 'window/stretch/aspect="expand"');
...
requireText("hud portrait command layout", hud, "command_status.custom_minimum_size = Vector2(94.0 if portrait else 126.0, 0)");
...
requireText("hud generated pixel UI", hud, "const UI_RD_PANEL");
requireText("hud generated pixel UI", hud, "StyleBoxTexture.new()");
requireText("hud generated pixel UI", hud, "ui_rd_status_bar_blue.png");
...
requireText("hud portrait responsive", hud, "ctrl_w = 58.0");
...
requireText("wager launch gate", startMenu, "waiting for accepted ticket");
...
requireText("start menu responsive", startMenu, "menu_box.scale = Vector2(1.22, 1.22) if portrait else Vector2.ONE");
...
requireText("start menu verified wallet", startMenu, "VERIFIED  ");
...
requireText("web shell fix", webShellFix, "width: 100vw");
requireText("web shell fix", webShellFix, "height: 100vh");
requireText("web shell fix", webShellFix, "memepireLowDpr");
requireText("web shell fix", webShellFix, "1/memepireLowDpr");
...
requireText("web export shell", html, "width: 100vw");
requireText("web export shell", html, "height: 100vh");
requireText("web export shell", html, "memepireLowDpr");
requireText("web export shell", html, "1/memepireLowDpr");
