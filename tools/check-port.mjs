...
requireText("main web unit sprite preview", main, "unitSpritePreview");
requireText("main web unit sprite preview", main, "func _web_unit_sprite_preview");
requireText("main web unit sprite preview", main, '"king": "wynn"');
requireText("main web unit sprite preview", main, '"lancer"');
requireText("main web unit sprite preview", main, '"siege"');
...
requireText("game opening resources", game, "const START_FOOD := 560");
requireText("game opening resources", game, "const START_TIMBER := 460");
requireText("game opening resources", game, "const START_MEMP := 120");
requireText("game opening resources", game, "const START_POP_CAP := 24");
requireText("game visible special resource", game, 'const SPECIAL_RESOURCE_LABEL := "TAPE"');
requireText("game visible special resource", game, 'const SPECIAL_RESOURCE_SHORT := "TP"');
requireText("main macro resources", main, "func _seed_macro_resources");
requireText("main macro resources", main, "credit_resource(st.team, \"food\", 4)");
requireText("main macro resources", main, "credit_resource(m.team, \"food\", 8)");
requireText("main wave pacing", main, "return 48.0");
...
requireText("main ansem sprite smoke", main, "readable_scale");
...
requireText("hud unit command icons", hud, "func _unit_command_icon");
requireText("hud unit command labels", hud, "func _unit_button_label");
requireText("hud unit command icons", hud, "func _visible_unit_icon_region");
requireText("hud unit command icons", hud, "AtlasTexture.new()");
requireText("hud unit command icons", hud, "Game.unit_sheet(king, kind)");
requireText("hud unit command icons", hud, "main.hud_controlled_king()");
requireText("hud unit command icons", hud, '"keep_enabled": true');
requireText("main controlled king HUD", main, "func hud_controlled_king()");
forbidText("hud unit command icons", hud, '"villager": "res://assets/ui/command_icon_villager.png"');
forbidText("hud unit command icons", hud, '"swordsman": "res://assets/ui/command_icon_swordsman.png"');
forbidText("hud unit command icons", hud, '"archer": "res://assets/ui/command_icon_archer.png"');
forbidText("hud unit command icons", hud, '"lancer": "res://assets/ui/command_icon_lancer.png"');
forbidText("hud unit command icons", hud, '"siege": "res://assets/ui/command_icon_siege.png"');
...
requireText("hud no visible memp banner", hud, "Game.SPECIAL_RESOURCE_LABEL");
forbidText("hud no visible memp banner", hud, "MEMP 0");
forbidText("hud no visible memp banner", hud, '"MEMP %d"');
...
requireText("server persistent leaderboard", server, "AVW_DATA_DIR");
requireText("server persistent leaderboard", server, ".avw-data");
...
requireText("net relay", net, "window.AVW_ROOM_RELAY");
requireText("game telemetry", game, "__avwState");
...
requireText("main menu contract address", startMenu, "CONTRACT_ADDRESS");
requireText("main menu contract address", startMenu, "5N69WTcXAGJtE16DM4N2yf3qE5HWowpTCvaygAQansem");
requireText("main menu contract address", startMenu, "CA  \" + CONTRACT_ADDRESS");
requireText("main menu contract address", startMenu, "DisplayServer.clipboard_set(CONTRACT_ADDRESS)");
requireText("brand contract address", server, "contractAddress");
requireText("brand contract address", server, "5N69WTcXAGJtE16DM4N2yf3qE5HWowpTCvaygAQansem");
...
requireText("leaderboard error state", startMenu, "WEB SCORES ERROR");
requireText("leaderboard plain scores", startMenu, "GAME SCORES");
requireText("leaderboard plain scores", startMenu, "leaderboard_panel.add_theme_stylebox_override(\"panel\", _flat_menu_panel())");
...
requireText("start menu responsive", startMenu, "var desktop_scale := 0.96 if display.y <= 900.0 else 1.0");
requireText("start menu responsive", startMenu, "menu_box.scale = Vector2(1.08, 1.08) if portrait else Vector2(desktop_scale, desktop_scale)");
requireText("start menu portrait sizing", startMenu, "port.expand_mode = TextureRect.EXPAND_IGNORE_SIZE");
requireText("start menu portrait sizing", startMenu, "port.custom_minimum_size = Vector2(118, 118)");
...
requireText("start menu web leaderboard", startMenu, "SYNCING SCORES");
...
requireText("start menu room links", startMenu, "join=1&king=%s&rival=%s");
requireText("wallet", wallet, "__avwWalletAddress");
requireText("wallet verified login", wallet, "__avwWalletToken");
requireText("wallet verified login", wallet, "signMessage");
requireText("wallet verified login", wallet, "window.__avwWalletVerified");
...
requireText("start menu verified wallet", startMenu, "SIGNED  ");
requireText("start menu phantom wallet", startMenu, "CONNECT PHANTOM");
requireText("start menu unsigned wallet", startMenu, "UNSIGNED MODE");
...
requireText("start menu launch readiness", startMenu, "START WAR");
requireText("server relay", server, 'url.pathname !== "/room"');
requireText("server relay", server, "Sec-WebSocket-Accept");
requireText("server relay", server, "AVW_ROOM_RELAY");
...
requireText("web visual check", webVisualCheck, "exported app reached desktop, unit sprite preview, fractional DPR, landscape mobile, and portrait mobile menu/match/result in Chrome");
requireText("web visual check", webVisualCheck, "window.__avwState");
...
requireText("web visual check", webVisualCheck, "unitSpritePreview=1");
...
requireText("web visual check", webVisualCheck, "unit-sprites-cdp.png");
...
requireText("web visual check", webVisualCheck, "waitForUnitSpritePreview");
...
requireText("web shell fix", webShellFix, "__avwNativeDevicePixelRatio");
requireText("web shell fix", webShellFix, "return 1;");
forbidText("web shell fix", webShellFix, "avwClampedDpr");
forbidText("web shell fix", webShellFix, "function avwScaleCanvas");
requireText("web shell fix", webShellFix, "function avwFitCanvas");
...
forbidText("web shell fix", webShellFix, "avwCanvas.width = width");
forbidText("web shell fix", webShellFix, "pixelSafeScale");
requireText("web export", html, "<title>Ansem vs Wynn</title>");
requireText("web export wallet", html, "__avwWalletToken");
forbidText("web export wallet", html, "window.AVWWallet");
...
requireText("web export shell", html, "__avwNativeDevicePixelRatio");
requireText("web export shell", html, "return 1;");
forbidText("web export shell", html, "__avwNativeDevicePixelRatio < 1");
requireText("web export shell", html, "function avwFitCanvas");
forbidText("web export shell", html, 'id="avw-frame"');
forbidText("web export shell", html, 'id="avw-cover-bottom"');
forbidText("web export shell", html, "avwSetCover");
...
forbidText("web export shell", html, "avwLowDpr");
forbidText("web export shell", html, "avwClampedDpr");
forbidText("web export shell", html, "pixelSafeScale");
forbidText("web export shell", html, "avwScaleCanvas");
forbidText("web export shell", html, "function avwResizeCanvas");
forbidText("stale web export shell", html, "avw-dpr-clamped");
...
requireText("main remote result smoke", remoteResultSmoke, "REMOTE_RESULT_SMOKE local_result=won king=wynn recorded=true");
...
requireText("main remote economy smoke", remoteEconomySmoke, "REMOTE_ECONOMY_SMOKE forge=true research=true siege=true market=true timber=5 memp=8 atk=3 ok=true");
...
console.log("[avw-port] Godot scenes, web export, wallet bridge, leaderboard, and multiplayer relay verified");
